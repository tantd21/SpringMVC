		...
		<div class="row">
			<div class="col-md-4 stretch-card grid-margin">
				<div class="card bg-gradient-danger card-img-holder text-white">
					<div class="card-body">
						<img
							src="<c:url value="/assets/admin/images/dashboard/circle.svg" />"
							alt="circle-image" class="card-img-absolute" />
					...
					<div class="card-body">
						...
						<div class="row mt-3">
							<div class="col-6 pe-1">
									...
									<img src="<c:url value="/assets/admin/images/dashboard/img_1.jpg" />" class="mb-2 mw-100 w-100 rounded" alt="image"/> 
									<img src="<c:url value="/assets/admin/images/dashboard/img_4.jpg" />" class="mb-2 mw-100 w-100 rounded" alt="image"/>
									
							</div>
							<div class="col-6 ps-1">
							<img src="<c:url value="/assets/admin/images/dashboard/img_2.jpg" />" class="mb-2 mw-100 w-100 rounded" alt="image"/>
							<img src="<c:url value="/assets/admin/images/dashboard/img_3.jpg" />" class="mw-100 w-100 rounded" alt="image"/>
							</div>
						</div>
						<div class="d-flex mt-5 align-items-top">
						<img src="<c:url value="/assets/admin/images/faces/face3.jpg" />" class="img-sm rounded-circle me-3" alt="image"/>
						...
						<div class="list-wrapper">
							<ul class="d-flex flex-column-reverse todo-list todo-list-custom">
								...
								<li class="completed">
									<div class="form-check">
										<label class="form-check-label"> <input
											class="checkbox" type="checkbox" checked> Prepare for
											presentation
										</label>
									</div> <i class="remove mdi mdi-close-circle-outline"></i>
								</li>
