		...
		<div class="card">
			<div class="card-body">
				<h4 style="margin-top: -15px" class="card-title">Thêm Loại Sản
					Phẩm</h4>
				<s:form class="forms-sample" action="/SpringMVC/admin/product-types/update-product-type"
					...
					<div class="form-group">
						<label for="exampleInputName1">Size Sản Phẩm</label> <input
							...
							id="name" placeholder="Name" value="${ productType.productTypeName }"> <span
							class="text-danger form-message mt-2"></span>
					</div>
					<input
							type="text" name="productTypeId" hidden value="${ productType.productTypeId }">
							<%-- <input
							type="text" name="createdAt" hidden value="${ productType.createdAt }"> --%>
					<div class="form-group">
					
						<label for="exampleTextarea1">Giá tương ứng</label> <input
							type="text" name="productTypePrice" class="form-control mb-2"
							id="price" placeholder="Price..." value="${ productType.productTypePrice }"> <span
							class="text-danger form-message mt-2"></span>
					</div>
                ...
                <div class="form-group">
						<label for="">Hiển thị</label> <select class="form-control"
							...
							<c:choose>
								<c:when test="${ productType.productTypeStatus == 1 }">
