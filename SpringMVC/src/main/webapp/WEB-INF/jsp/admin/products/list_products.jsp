...
<body>
					...
					<tbody id="loading-table-product">
						<c:forEach items="${ products.content }" var="product">
							<tr>
								...
								<td id="un_active${ product.productId }"><c:choose>
								...
								<td><a
									href="/SpringMVC/admin/products/product-detail?productId=${ product.productId }">
										<button type="button"
	...
	<script type="text/javascript">
		...
		$('tbody').on('click', '.btn-un-active', function() {
            ...
            $.ajax({
                url: '/SpringMVC/admin/products/un-active-product?productId=' + product_id + "&status=" + status,
                method: 'get',
                data: {
                },
                success: function(data) {
