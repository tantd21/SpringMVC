...
<nav
	...
	<div
		...
		<a class="navbar-brand brand-logo" href="index.html"><img
			src='<c:url value="/assets/admin/images/logo.svg" />' alt="logo" /></a>
		<a class="navbar-brand brand-logo-mini" href="index.html"><img
			src="<c:url value="/assets/admin/images/logo-mini.svg"/>" alt="logo" /></a>
	</div>
		...
		<ul class="navbar-nav navbar-nav-right">
			<li class="nav-item nav-profile dropdown"><a
				...
				data-bs-toggle="dropdown" aria-expanded="false">
					<div class="nav-profile-img">
						<img src="<c:url value="/assets/admin/images/faces/face1.jpg"/>"
			...
			<li class="nav-item dropdown"><a
				...
				<div
					...
					<a class="dropdown-item preview-item">
						<div class="preview-thumbnail">
							<!-- <img src="assets/images/faces/face4.jpg" alt="image"
								class="profile-pic"> -->
							<img src="<c:url value="/assets/admin/images/faces/face4.jpg" />"
					...
					<a class="dropdown-item preview-item">
						<div class="preview-thumbnail">
							<img src="<c:url value="/assets/admin/images/faces/face2.jpg" />"
								alt="image" class="profile-pic">
						</div>
						<div
							class="preview-item-content d-flex align-items-start flex-column justify-content-center">
					...
					<a class="dropdown-item preview-item">
						<div class="preview-thumbnail">
							<!-- <img src="assets/images/faces/face3.jpg" alt="image"
								class="profile-pic"> -->
							<img src="<c:url value="/assets/admin/images/faces/face3.jpg" />"
								alt="image" class="profile-pic">
						</div>
						<div
							class="preview-item-content d-flex align-items-start flex-column justify-content-center">
		...
		<ul class="nav">
			...
			<li class="nav-item"><a class="nav-link"
				...
				<div class="collapse" id="ui-basic">
					<ul class="nav flex-column sub-menu">
						<li class="nav-item"><a class="nav-link"
							href="/SpringMVC/admin/products">List Products</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/SpringMVC/admin/products/add-product">Add New Product</a></li>
					</ul>
				</div></li>
			<li class="nav-item"><a class="nav-link"
				data-bs-toggle="collapse" href="#ui-user" aria-expanded="false"
				aria-controls="ui-basic"> <span class="menu-title">Category
						Manage</span> <i class="menu-arrow"></i> <i
					class="mdi mdi-crosshairs-gps menu-icon"></i>
			</a>
				<div class="collapse" id="ui-user">
					<ul class="nav flex-column sub-menu">
						<li class="nav-item"><a class="nav-link"
							href="/SpringMVC/admin/categorys">List Category</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/SpringMVC/admin/categorys/add-category">Add New
								Category</a></li>
					</ul>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link"
				...
				<div class="collapse" id="ui-basic-coupon">
					...
					<ul class="nav flex-column sub-menu">
						<li class="nav-item">Flashsale Manage</li>
						<li class="nav-item"><a class="nav-link"
			...
			<li class="nav-item"><a class="nav-link"
				...
				aria-expanded="false" aria-controls="general-pages"> <span
					class="menu-title">Sample Pages</span> <i class="menu-arrow"></i> <i
